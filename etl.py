...
def process_song_file(cur, filepath):
    """
        Read song file and insert record into songs and artists tables.
...
def process_log_file(cur, filepath):
    """
        Read log file and insert record into song_play, user and time_tables.
...
def process_data(cur, conn, filepath, func):
    """
        ...
        Arguments:
            cur: reference to connected db.
            conn: db connection object (host, dbname, user, password).
            filepath: path to file.
